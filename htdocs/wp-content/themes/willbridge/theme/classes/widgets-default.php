...
class WP_Widget_RSS_Custom extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if ( $title )
			$title = "<a class='rsswidget' href='$url' title='" . esc_attr__( 'Syndicate this content' ) ."'><img style='border:0' width='14' height='14' src='$icon' alt='RSS' /></a> <a class='rsswidgettitle' href='$link' title='$desc'>$title</a>";
